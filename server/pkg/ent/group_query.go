...
func (gq *GroupQuery) QueryFeeds() *FeedQuery {
	query := &FeedQuery{config: gq.config}
...
func (gq *GroupQuery) WithFeeds(opts ...func(*FeedQuery)) *GroupQuery {
	query := &FeedQuery{config: gq.config}
...
func (gq *GroupQuery) sqlAll(ctx context.Context) ([]*Group, error) {
	...
	if query := gq.withFeeds; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(group.FeedsPrimaryKey[0], fks...))
			},
