...
func (gc *GroupCreate) AddFeedIDs(ids ...int) *GroupCreate {
	gc.mutation.AddFeedIDs(ids...)
	return gc
}

// AddFeeds adds the "feeds" edges to the Feed entity.
func (gc *GroupCreate) AddFeeds(f ...*Feed) *GroupCreate {
	ids := make([]int, len(f))
	for i := range f {
		ids[i] = f[i].ID
	}
	return gc.AddFeedIDs(ids...)
}
...
func (gc *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if nodes := gc.mutation.FeedsIDs(); len(nodes) > 0 {
